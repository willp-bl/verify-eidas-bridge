...
public class AuthnRequestFormGenerator {
    ...
    public SamlRequest generateAuthnRequestForm(String authnRequestId, String destinationEntityId, AuthnContext lowestAuthnContext) throws MarshallingException, SignatureException, SecurityException {
        AuthnRequest eidasAuthnRequest = eidasAuthnRequestGenerator.generateAuthnRequest(authnRequestId, destinationEntityId, lowestAuthnContext);
