...
public class SendAuthnRequestToBridgeIntegrationTest {
    ...
    private static Map<String, Supplier<CountryConfiguration>> countryConfig = ImmutableMap.of(
        COUNTRY_CODE, () -> new CountryConfiguration(nlMetadata.url(), COUNTRY_CODE, null, false),
        "SE", () -> new CountryConfiguration(eidasMetadataWithoutSignedSSODescriptor.url(), "SE", null, /* workaroundBrokenRoleDescriptorSignatures = */ true)
    );
