...
public class BridgeApplicationIntegrationTest {
    ...
    private static final DropwizardTestSupport<BridgeConfiguration> dropwizardTestSupport = new DropwizardTestSupport<>(BridgeApplication.class,
        ...
        ConfigOverride.config("eidasMetadata.countries[1].base64Value", metadataTrustStore),
        ConfigOverride.config("eidasMetadata.countries[1].password", KEYSTORE_PASSWORD),
        ConfigOverride.config("eidasMetadata.countries[1].entityID", "http://some-other-url.com"),
